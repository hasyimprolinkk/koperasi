...
<div class="row row-cards row-deck">
    <div class="col-10 offset-md-1">
        <div class="card">
            ...
            <form enctype="multipart/form-data" action="{{ route('members.update', $member->id) }}" method="POST">
                @csrf
                {{ method_field('PATCH') }}
                <div class="card-body">
                    <div class="form-group">
                        ...
                        @if ($errors->has('ktp'))
                            <span class="invalid-feedback">{{ $errors->first('ktp') }}</span>
                        @endif
                    </div>    
                    <div class="form-group">
                        <label class="form-label">KK</label>
                        <input type="file" name="kk" class="form-control{{ $errors->has('kk') ? ' is-invalid' : '' }}">
                        @if ($errors->has('kk'))
                            <span class="invalid-feedback">{{ $errors->first('kk') }}</span>
                        @endif
                    </div>
                    <div class="form-group">
