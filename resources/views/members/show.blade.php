    ...
    <div class="col-10 offset-md-1">
        <div class="card">
            ...
            <table class="table card-table">
                <tbody>
                    <tr>
                        <td style="width: 25%;" class="text-muted">KTP</td>
                        <td><img src="{{ url("/uploads/ktp/$member->ktp") }}" width="50%" alt=""></td>
                    </tr>
                    <tr>
                        <td style="width: 25%;" class="text-muted">KK</td>
                        <td><img src="{{ url("/uploads/kk/$member->kk") }}" width="50%" alt=""></td>
                    </tr>
                    <tr>
