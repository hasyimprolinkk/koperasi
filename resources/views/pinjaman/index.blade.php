        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-options">
                    ...
                    <a href="{{ route('pinjaman.create') }}" class="btn btn-sm btn-pill btn-primary">Tambah Pinjaman</a>
                    @else
                    <!-- <a href="#" class="btn btn-sm btn-pill btn-info">Print Pinjaman</a> -->
                    @endif
                </div>
            </div>
            <div class="card-body">
